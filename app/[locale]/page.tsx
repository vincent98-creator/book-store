...
export default function Home() {
  ...
  const BOOKS = [
    ...
    {"id": 3, "title": t("Awesome Book"), "author": t("Michael Johnson"), "price": 250},
    {"id": 4, "title": t("Great Book"), "author": t("Emily Davis"), "price": 300},
    {"id": 5, "title": t("Fantastic Book"), "author": t("David Lee"), "price": 450},
    {"id": 6, "title": t("Incredible Book"), "author": t("Sophia Brown"), "price": 200},
    {"id": 7, "title": t("Amazing Book"), "author": t("Robert Williams"), "price": 350},
